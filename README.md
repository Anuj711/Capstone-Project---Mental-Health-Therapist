...
2. To fix package issues:
   _npm audit fix_

3. To fix an incompatible version of Node (v25 or later), "Error saving to database: Cannot read properties of undefined (reading 'prototype')": 
